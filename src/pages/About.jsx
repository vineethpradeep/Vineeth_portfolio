  ...
  return (
    <StyledElement name="about">
      <Wrapper>
        ...
        <ToggleParagraph>
          I am a passionate and experienced Product Designer and FullStack
          Developer with over a decade of expertise in building scalable, high
          performance digital products. My career spans freelance projects and
          platform companies, allowing me to deliver end-to-end solutions that
          blend intuitive user experiences with robust, future-ready
          ...
          My expertise in frontend and UI development has evolved over the past
          decade into fullstack mastery, enabling me to build scalable, user
          ...
          on seamless API integrations, real-time interfaces, and component
          driven architectures that scale with evolving business needs. From
          responsive web apps to native mobile solutions, I prioritize high
